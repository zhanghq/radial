...
namespace Radial.UnitTest.Nhs.Param
{
    ...
    public class SqlServerTest
    {
        ...
        public void SetUp()
        {
            //Radial.ComponentContainer.RegisterSingleton<Radial.Data.Nhs.Param.IParamRepository, Radial.Data.Nhs.Param.SqlServerParamRepository>();
            //Radial.ComponentContainer.RegisterSingleton<Radial.Param.IParam, Radial.Data.Nhs.Param.DefaultParam>();

            //ComponentContainer.RegisterPerThread<IFactoryPoolInitializer, SqlServerFactoryPoolInitializer>();
        ...
        public void Create()
        {
            ...
            ParamObject po = AppParam.Create(ParamObject.BuildPath(path), "斯蒂芬", "");
            ParamObject po2 = AppParam.Create(ParamObject.BuildPath(path,"level1"), "阿萨德", "");
            Assert.True(AppParam.Next(path)[0].Path == po2.Path);
            AppParam.Create(ParamObject.BuildPath(path, "level2"), "阿萨德", "");
